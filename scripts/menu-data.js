window.ODIN_MENU_SECTIONS = [
  {
    ...
    layout: "menuList",
    items: [
      { name: "Курячі стріпси", photo: "assets/menu-photos/kuryachi-stripsy.jpg", price: "180 грн", accent: "ember" },
      { name: "Сирні палички", photo: "assets/menu-photos/syrni-palychky.jpg", price: "140 грн", accent: "cream" },
      { name: "Картопля фрі", photo: "assets/menu-photos/kartoplia-fri.jpg", price: "140 грн", accent: "gold" },
      { name: "Батат фрі", photo: "assets/menu-photos/batat-fri.jpg", price: "140 грн", accent: "salmon" }
    ]
  },
  {
    id: "snacks",
  ...
  },
  {
    ...
    layout: "compact",
    items: [
      { name: "Вода Borjomi", photo: "assets/menu-photos/voda-borjomi.jpg", price: "160 грн", accent: "frost" },
  ...
  },
  {
    ...
    layout: "compact",
    items: [
      { name: "Айс латте", photo: "assets/menu-photos/ais-kava.jpg", price: "150 грн", accent: "frost" },
      { name: "Американо", photo: "assets/menu-photos/amerykano.jpg", price: "80 грн", accent: "wood" },
...
window.ODIN_NAV_ITEMS = window.ODIN_MENU_SECTIONS.map(({ id, label }) => ({ id, label }));
